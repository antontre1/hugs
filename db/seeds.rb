...
10.times {
  ...
  new_hug = Hug.new(user_id: users.sample.id, title: Faker::Fantasy::Tolkien.location ,category: fake_cat, description: Faker::Fantasy::Tolkien.poem, address: Faker::Address.full_address, price: (2..25).to_a.sample )
